...
The marketing/docs site for this package family lives at [`apps/site`](apps/site) (an Nx Angular application with static prerendering), deployed to Cloudflare Pages at [https://i18n.ashwinsathian.com](https://i18n.ashwinsathian.com). See [`apps/site/README.md`](apps/site/README.md) for local dev, build, and test commands.
